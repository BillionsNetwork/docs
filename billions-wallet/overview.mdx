...
<Steps>
  <Step title="Open the Wallet">
    Visit [wallet.billions.network](https://wallet.billions.network) or open the Billions Wallet App. Sign in with Google, Apple ID, or a crypto wallet.
  </Step>
...
Official Profiles by Billions are the standard for proving authenticity in a world of scams and AI-generated content. Available at [wallet.billions.network](https://wallet.billions.network/official-profile), each profile carries a badge that signals who is real and trustworthy — while keeping personal data private.

> "Official Profiles proves who's real. Official Profiles keeps your privacy intact. The solution against scams."

Every Billions Wallet holder has a public profile page that shows the credentials and badges they have earned, without exposing any underlying personal data.
