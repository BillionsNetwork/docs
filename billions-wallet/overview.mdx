...
<CardGroup cols={2}>
  ...
  <Card title="Verified Human" icon="user-check" href="/billions-wallet/verified-human">
    A KYC-style credential from a government-issued document — NFC passport, Aadhaar, driving license, or national ID.
  </Card>
